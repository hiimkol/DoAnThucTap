...
INSERT INTO reader(reader.username,reader.password,reader.name,reader.email)
VALUES('user','123','Trần Vương Quang', 'hiimkol@gmail.com');
...
Sasuke và Itachi đã gặp nhau. Và trận chiến cuối cùng đã xảy ra với chiến thắng của Sasuke.','https://orig00.deviantart.net/3a9c/f/2012/191/c/d/naruto_cute_by_tania15-d56p6av.jpg'),
...
('Hiệp khách giang hồ','Câu chuyện xoay quanh nhân vật chính là Hàn Bảo Quân, một kẻ không có võ công nhưng lại có khinh công tuyệt đỉnh và tài bắt chước võ công của người khác dù chỉ nhìn qua một lần. Cùng với Đàm Hoa Liên, cháu gái của Kiếm Hoàng, họ bị cuốn vào bí mật của Phục Ma Hoa Linh Kiếm, 1 trong 8 kỳ vật của võ lâm.','https://1.bp.blogspot.com/-0-TnocG4MqI/WfnkoNDrcpI/AAAAAAAAAC0/MZ02n77iwA8MCsA2rcGJLQ9jB6Oy4B57wCHMYCw/s0/001.jpg'),
('Toriko','Câu chuyện kể vể Toriko một thợ săn pro thường xuyên cung cấp các loại thực phẩm quý giá cho nhà hàng và những người giàu có, một anh chàng có đầy sức mạnh để săn bắt các loài động vật hung dữ .','https://1.bp.blogspot.com/-iIibg2VaNw8/WiBP4IF22CI/AAAAAAAAATI/lr7__jSqIVYYxOry4BolkNmnRbB29anHgCHMYCw/s0/eb8084f8230108f487402956e9984f1c1384463925_full.jpg'),
('YUGI-OH!','Yugi-Oh! từ tập 1 tới tập 16 đã được NXB Kim Đồng xuất bản ở Việt Nam với cái tên "Vua Trờ Chơi" 21 tập (bằng 16 tập theo tập nguyên gốc tiếng Nhật). Dưới đây là phần tiếp theo của bộ truyện, cũng là phần chính trong toàn cốt truyện.
','https://3.bp.blogspot.com/-JN7uXaKM2ts/UAevnfdUMpI/AAAAAAAAAV8/jDDCJkSEeU4/yugijoeykaibaandthe3god.gif');
...
INSERT INTO reader_manga(reader_manga.id_manga, reader_manga.username)
